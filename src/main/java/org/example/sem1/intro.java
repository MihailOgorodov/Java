...
////        char ch; // 16 бит целое, беззнаковое. индекс символа в таблице символов. То есть если в char = 'e', то это будет индекс буквы е в таблице букв.
////        // '' - индексы, "" - текст
////        String s = "=) "; // текст
...
////    }
//
////    print("=) ".repeat(5)); // " " - это полноценный метод String и можем делать с ним все тоже самое
//
//
